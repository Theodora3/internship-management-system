...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // Αναζητούμε τον χρήστη με το username
        ...
        // Όταν βρούμε τον χρήστη, τυπώνουμε τα αποτελέσματα
        System.out.println("✅ Loaded user: " + user.getUsername());
        
        // Ελέγχουμε αν ο κωδικός είναι σωστός (π.χ. για την ανάπτυξη ή debugging)
        ...
        // Ελέγχουμε τον ρόλο του χρήστη
        if (user.getRole() != null) {
        	System.out.println("🎭 Role: " + user.getRole());
  
        } else {
            System.out.println("⚠️ User has no role assigned!");
        }

        return new CustomUserDetails(user);  // Επιστρέφουμε την CustomUserDetails για την ασφαλή διαχείριση του χρήστη
    }
}
